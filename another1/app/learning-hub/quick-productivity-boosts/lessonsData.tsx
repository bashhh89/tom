...
export const lessons = [
  {
    ...
    content: (
      <div className="space-y-6">
        ...
        <div className="text-lg text-brand-dark-teal space-y-4">
          <p>You've met ChatGPT (or a similar AI tool) and understand the basics. Now, let's put it to work on those small, everyday tasks that eat up valuable time! This course focuses on quick, practical ways AI can boost your productivity with minimal effort.</p>
          <p>Think of this as your AI "quick wins" playbook for common administrative and communication tasks. We'll cover using AI for drafting emails, summarizing information, brainstorming simple lists, and basic proofreading.</p>
        </div>
