...
// Try to import Resend, but handle it gracefully if it's missing
let Resend: any;
...
export async function POST(request: Request) {
  try {
    ...
    if (resend) {
      ...
      console.log('Resend API key or module not available. Lead information:', {
        subject: emailSubject,
